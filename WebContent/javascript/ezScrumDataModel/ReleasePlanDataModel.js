...
var createReleaseStoryCloumns = function () {
    var columns = [
        { dataIndex: 'Id', header: 'ID', width: 50, /*renderer: makeIssueDetailUrl*/ },	//	makeIssueDetailUrl function in IssueGridPanelSupport.js
        ...
        { dataIndex: 'Release', header: 'Release Id', width: 90 },
        { dataIndex: 'Sprint', header: 'Sprint Id', width: 90}
        ];
...
var ReleaseBacklogGridExpander = new Ext.ux.grid.RowExpander({
    tpl : new Ext.XTemplate(
        ...
        '<tpl if="Value"><p><b>Value:</b><br /> {Value:nl2br}</p></tpl>',
