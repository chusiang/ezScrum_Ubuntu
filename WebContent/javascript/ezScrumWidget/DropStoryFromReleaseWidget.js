...
ezScrum.DropStoryFromReleaseWidget = Ext.extend(Ext.Window, {
			...
			initComponent : function() {
				...
				ezScrum.DropStoryFromReleaseWidget.superclass.initComponent
			...
			onSuccess : function(response) {
                ...
                if (ConfirmWidget.confirmAction()) {
					...
					if (record) {
						this.fireEvent('DropStorySuccess', this, response,
								record.data['Id']);
					} else
						this.fireEvent('DropStoryFailure', this, response,
								this.issueId);
                }
			},
			onFailure : function(response) {
				...
				this
						.fireEvent('DropStoryFailure', this, response,
								this.issueId);
			}
		});