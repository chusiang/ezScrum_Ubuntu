...
ezScrum.AddNewReleaseWidget = Ext.extend(Ext.Window, {
			...
			initComponent : function() {
				...
				ezScrum.AddNewReleaseWidget.superclass.initComponent.apply(
						this, arguments);
				...
				Ext.Ajax.request({
							...
							success : function(response) {
						    	...
						    	if (ConfirmWidget.confirmAction()) {
									var rs = newReleaseIDReader
											.readRecords(response.responseXML);
									if (rs.success) {
...
ezScrum.ReleaseDetail = Ext.extend(Ext.FormPanel, {
			...
			initComponent : function() {
				var config = {
					autoScroll : true,
					items : [ReleaseId, Name,ReleaseStartDate, ReleaseEndDate, Description, action, { xtype: 'RequireFieldLabel' }],
					buttons : [{
								formBind : true,
								text : 'Submit',
								scope : this,
				...
				Ext.apply(this, Ext.apply(this.initialConfig, config));
				ezScrum.ReleaseDetail.superclass.initComponent.apply(this,
						arguments);
			...
			onSubmitSuccess : function(response) {
				ConfirmWidget.loadData(response);
		    	if (ConfirmWidget.confirmAction()) {
					this.fireEvent('SubmitSuccess', this, response, this.getForm()
									.getValues());
		    	}
				// this.ownerCt.hide();
			},
