...
ezScrum.window.ShowReleaseBacklogWindow = Ext.extend(ezScrum.layout.Window, {
	...
	initComponent : function() {
		var config = {
				items	:[
					{ref: 'ReleaseStoryBurndownChart_refID', xtype: 'ReleaseStoryBurndownChart'},
					{ref: 'ReleaseBacklogGridPanel_refID', xtype: 'ReleaseBacklogGridPanel'}
	     	    ],
	     	    buttons: [{
		        	text	: 'Close',
		        	scope	: this,
