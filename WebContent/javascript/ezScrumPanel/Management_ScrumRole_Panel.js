	...
	notify_Permisiion_List_Check: function() {
		if ( (this.ProjectID !== undefined) && (this.ScrumRole !== undefined) ) {
			...
			Ext.Ajax.request({
				...
				params	: { projectName: this.ProjectID, scrumRole: this.ScrumRole },
...
ezScrum.Management_ScrumRole_Panel = Ext.extend(Ext.Panel, {
	...
	initComponent : function() {
		var config = {
			...
			items   : [
			    { flex: 1, xtype : 'Management_ScrumRole_ProjectListPanel', ref : 'Management_ScrumRole_ProjectListPanel_refID' },
			    { html: '>>' },
			    { flex: 1, xtype : 'Management_ScrumRole_RoleListPanel', ref : 'Management_ScrumRole_RoleListPanel_refID' },
			    { html: '>>' },
			    { flex: 1, xtype : 'Management_ScrumRole_PermissionListPanel', ref : 'Management_ScrumRole_PermissionListPanel_refID' }
			]
		}
