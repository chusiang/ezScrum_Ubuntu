	...
	initComponent : function() {
		var config = {
		    bbar : new Ext.PagingToolbar({
				...
				items		:[
						 		{ text:'Expand All', icon:'images/folder_out.png', handler:function() { ReleaseBacklogGridExpander.expandAll(); } },
						 		{ text:'Collapse All', icon:'images/folder_into.png', handler:function() { ReleaseBacklogGridExpander.collapseAll(); } }
				     		  ] 
			})
		}
	...
	loadDataModel: function(){
		...
		Ext.Ajax.request({
			...
			success : function(response) {
				...
				ReleaseBacklogStoryStore.load({params:{start:0, limit:pageSize_ReleaseBacklog}});
